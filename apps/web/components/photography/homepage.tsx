...
export function Homepage({ locale, workPhotographs }: { locale: Locale; workPhotographs: Photograph[] }) {
  ...
  return <div className={styles.site} lang={locale === "zh" ? "zh-CN" : "en"}>
    ...
    <main>
      ...
      <section id="selected-work" className={styles.work} aria-labelledby="work-heading" tabIndex={-1}>
        ...
        <div className={styles.motionControl}><button onClick={() => setPaused(!paused)} aria-pressed={paused}>
